<template>
  <view class="page">
    ...
    <view class="navbar">
      ...
      <text class="nav-title">星盘咨询</text>
      <view class="nav-right" />
    </view>

    <view class="head">
      <text class="title">🔭 星盘咨询</text>
      <text class="sub">花园对你的长期理解 · 带着星盘的视角看生活的难题</text>
...
.card-conf { color: rgba(232, 245, 233, 0.5); font-size: 22rpx; }
.card-summary { color: #e8f5e9; font-size: 28rpx; line-height: 1.7; }
.card-notes { margin-top: 12rpx; }
.note { color: rgba(232, 245, 233, 0.65); font-size: 24rpx; line-height: 1.6; display: block; }
.empty { color: rgba(232, 245, 233, 0.6); font-size: 28rpx; text-align: center; padding: 100rpx 0; }
.card-sub { color: rgba(232, 245, 233, 0.5); font-size: 22rpx; display: block; margin-top: 6rpx; margin-bottom: 12rpx; }
.finding { padding: 16rpx 0; border-top: 1rpx solid rgba(255, 255, 255, 0.06); }
.finding-meta { display: flex; align-items: center; gap: 12rpx; margin-top: 6rpx; }
.finding-conf { color: rgba(232, 245, 233, 0.5); font-size: 22rpx; }
...
.btn.yes { background: rgba(124, 179, 66, 0.25); color: #a5d6a7; }
.btn.no { background: rgba(255, 179, 77, 0.15); color: #ffb74d; }
.sub-note { color: rgba(232, 245, 233, 0.4); font-size: 22rpx; display: block; margin: 20rpx 0 8rpx; }
.finding.verified .note { color: rgba(232, 245, 233, 0.55); }
.finding-status { color: rgba(232, 245, 233, 0.45); font-size: 22rpx; display: block; margin-top: 6rpx; }
</style>
